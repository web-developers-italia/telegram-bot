...
* **Refresh `/learn` (2026)**: risorse riviste con ricerca social (last30days) + context7. Fuori jsforcats, You-Dont-Know-JS, free-programming-books, Codecademy (ferme o freemium); dentro MDN Learn web development, The Odin Project, project-based-learning, e una sezione agenti AI (roadmap.sh/ai-agents, HF Agents Course, guide Anthropic su agenti/context engineering, LangGraph). Nota anti tutorial-hell e uso dell'AI come tutor.
